...
namespace UE::ToolsetRegistry
{
	...
	public:
		...
		/// Description of script exceptions raised by UE::MCP::Compatibility::RaiseScriptError or
		...
		/// UE::MCP::Compatibility::RaiseScriptError() without dynamically calling a UFunction.
		/// 
		...
		/// which results in UE::MCP::Compatibility::RaiseScriptError() silently doing nothing.
		/// 
		...
		/// UE::MCP::Compatibility::RaiseScriptError() within Func will notify this class of the
		/// errors.
		/// 
	...
	private:
		// Track script exceptions raised by UE::MCP::Compatibility::RaiseScriptError or
