...
struct FJsonSchemaPropertyFilter
{
	...
	JSONSCHEMA_API explicit FJsonSchemaPropertyFilter(
	...
	JSONSCHEMA_API FJsonSchemaPropertyFilter(const FJsonSchemaPropertyFilter& Other);
	 ...
	 */
	JSONSCHEMA_API bool IsPropertyIgnored(TNotNull<const FProperty*> Property) const;
	 ...
	 */
	JSONSCHEMA_API bool IsPropertyMemberPathRequired(const FString& PropertyMemberPath) const;
	 ...
	 */
	JSONSCHEMA_API bool IsPropertyMemberPathSkipped(const FString& PropertyMemberPath) const;
	 ...
	 */
	JSONSCHEMA_API FString PropertyAuthoredNameToJsonKey(const FString& PropertyAuthoredName) const;
};
