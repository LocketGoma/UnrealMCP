...
public:
	 ...
	 */
	JSONSCHEMA_API static const FStringView Delimiter;

	JSONSCHEMA_API FJsonSchemaMemberPath();
	JSONSCHEMA_API FJsonSchemaMemberPath(const FJsonSchemaMemberPath& InMemberPath);
	FJsonSchemaMemberPath(FJsonSchemaMemberPath&& Other) = default;
	JSONSCHEMA_API explicit FJsonSchemaMemberPath(FStringView InitialString);

	JSONSCHEMA_API FJsonSchemaMemberPath& operator=(const FJsonSchemaMemberPath& Other);
	 ...
	 * @return Success.
	 */
	JSONSCHEMA_API bool Push(FStringView String);
	 ...
	 * @return Success.
	 */
	JSONSCHEMA_API bool Pop(FStringView String);
	 ...
	 * @return Success.
	 */
	JSONSCHEMA_API bool PushSubmember(FStringView SubmemberString);
	 ...
	 * @return Success.
	 */
	JSONSCHEMA_API bool PopSubmember(FStringView SubmemberString);
