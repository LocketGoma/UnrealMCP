...
struct FImportInspectionResult
{
	...
	TUniquePtr<FMCPZipArchiveReader> Reader; // Keep derived ownership: FZipArchiveReader has no virtual destructor.
	...
	explicit FImportInspectionResult(TUniquePtr<FMCPZipArchiveReader> InReader);
 ...
 * @note Creates IFileHandle that FMCPZipArchiveReader takes ownership of until destroyed.
 */
